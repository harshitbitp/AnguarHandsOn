...
export class EmployeeListComponent implements OnInit {
  ...
  constructor() { }
    employeeList: Employee[] = [
      ...
      {id : 2, name : 'Harry', salary : 10000, permanent : true, dept: { department_id: 1, department_name: "Payroll" }, skill: [{id: 1, name : 'HTML'},{id: 2, name : 'CSS'},{id:3, name : 'JAVASCRIPT'}], dateOfBirth : new Date('12/31/2000') },
